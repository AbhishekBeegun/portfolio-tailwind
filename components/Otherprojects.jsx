...
function Otherprojects() {
  return (
    <div className="h-full flex flex-col gap-5 lg:grid grid-cols-2">
      ...
      <a href="https://portfolio-abhishekbeegun.vercel.app" target={"_blank"} rel="noreferrer"
        ...
        <a href="https://molocal.vercel.app" target={"_blank"} rel="noreferrer"
        className="h-48 lg:h-96 bg-cyan-400 rounded-md cursor-pointer flex flex-col justify-evenly items-center">
          <h1 className=" text-white text-lg lg:text-2xl">
          MO LOCAL concept
          </h1>
        ...
        className="h-48 lg:h-96 bg-black rounded-md cursor-pointer flex flex-col justify-evenly items-center border">
