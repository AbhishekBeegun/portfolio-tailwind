...
function Otherprojects() {
  return (
    <div className="h-full flex flex-col gap-5 lg:grid grid-cols-2">
      ...
      <a href="https://portfolio-abhishekbeegun.vercel.app" target={"_blank"}
        ...
        <a href="https://dashboard-eta-five.vercel.app" target={"_blank"}
        ...
        <a href="https://molocal.vercel.app" target={"_blank"}
