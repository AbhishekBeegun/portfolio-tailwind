...
const SmallProject = ({title,ahref,techuse,color}) => {
  return (
    <>    
    ...
    className="h-48 lg:h-96 rounded-md cursor-pointer flex flex-col justify-evenly items-center">
    <h1 className=" text-white text-lg lg:text-2xl">
    {title} 
    </h1>

    <h4 className="text-base uppercase text-white lg:text-lg">
      {techuse}         
    </h4>
