...
const Projects1 = ({Projects1}) => {
  return (
        ...
        <div className="h-full w-full">
          ...
          src={urlFor(Projects1.image)} alt="" />

          <div className=" absolute top-0 h-full w-full p-8 flex flex-col justify-evenly">
            <h1 className=" text-white text-2xl">{Projects1.project}
            </h1>


            <h3 className="text-white text-sm">{Projects1.desc}
            </h3>
            ...
            <div className="h-10 bg-black rounded-3xl flex flex-row justify-evenly items-center">
              ...
              <a href="https://github.com/AbhishekBeegun/Beegun-Design-Studio" target={"_blank"} rel="noreferrer" 
              className="cursor-pointer">
